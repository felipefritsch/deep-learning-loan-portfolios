% ============================================================
%  Chapter 4 — Results
%  Status (M11b, June 2026): §4.1 (tuning window, tasks M7–M9 + M10b
%  depth check) and §4.2 (rolling backtest + evaluation suite, M10b–M11)
%  carry real numbers and real artifacts from outputs/. §4.3 remains
%  structured but PENDING Phase 3 (tasks M13–M15); its four placeholders
%  are intentionally left. All numbers/tables/figures here trace to
%  outputs/{tables,figures}/loan_level and models/ on the data drive.
% ============================================================
