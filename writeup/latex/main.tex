...
\renewcommand{\crest}{\hbox to\textwidth{\hss\includegraphics[width=35mm]{oxlogo}\hss}}
...
%chapters
\include{chapter1}          % Introduction & contributions
\include{chapter2}          % Methodology
\include{chapter3}          % Data & exploratory evidence
\include{chapter4}          % Results (partial — M10b/M11/Phase 3 pending)
\include{conclusions}
...
\include{appendix1}
\include{appendix2}
\include{appendix3}          % Deep-Learning Foundations (course crosswalk)
